...
Sclean=0.02;%Clean electricity tariff (CNY/kWh) 
lamda = 0;
...
z=0;
for N = 25:1:40
    for Alpha = 0.01:0.01:0.11
    
EP = ones(M,N).*Sclean;%µç¼Û²¹Ìù
CP = fun_GBM(dt,r2,sigma2,N,M,CP0);%Ì¼¼Û
